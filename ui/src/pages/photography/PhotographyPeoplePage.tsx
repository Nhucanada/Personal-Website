...
import { peoplePhotos, peopleSubcategories } from '../../data/photography';
import { getOptimizedPhotoSrc } from '../../utils/photoOptimization';
import '../../styles/photography.css';

const PhotographyPeoplePage: React.FC = () => {
      ...
      <section className="photo-body">
        ...
        <div className="photo-work-categories">
          {peopleSubcategories.map((sub) => (
            <Link key={sub.slug} to={`/photo/work/people/${sub.slug}`}>
              {sub.label}
            </Link>
          ))}
        </div>
...
export default PhotographyPeoplePage;
