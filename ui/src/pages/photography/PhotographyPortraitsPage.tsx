...
import { portraitPhotos, portraitSubcategories } from '../../data/photography';
import { getOptimizedPhotoSrc } from '../../utils/photoOptimization';
import '../../styles/photography.css';

const PhotographyPortraitsPage: React.FC = () => {
    ...
    <div className="photo-site">
      <section className="photo-body">
        ...
        <div className="photo-work-categories">
          {portraitSubcategories.map((sub) => (
            <Link key={sub.slug} to={`/photo/work/portraits/${sub.slug}`}>
              {sub.label}
            </Link>
          ))}
        </div>
...
export default PhotographyPortraitsPage;
