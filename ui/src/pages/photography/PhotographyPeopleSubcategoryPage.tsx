...
import { getPeopleSubcategoryBySlug } from '../../data/photography';
import { getOptimizedPhotoSrc } from '../../utils/photoOptimization';
import '../../styles/photography.css';

const PhotographyPeopleSubcategoryPage: React.FC = () => {
  ...
  const matched = getPeopleSubcategoryBySlug(normalizedSlug);

  if (!matched) {
    return <Navigate to="/photo/work/people" replace />;
  }
    ...
    <div className="photo-site">
      <section className="photo-body">
        <div className="photo-work-back-row">
          <Link to="/photo/work/people" className="photo-back-link">
...
export default PhotographyPeopleSubcategoryPage;
